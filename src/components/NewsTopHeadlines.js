...
export class NewsTopHeadlines extends Component {
  constructor() {
    super();
    this.state = {
      articles: [],
  ...
  async componentDidMount() {
    ...
    let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=42d65406e6d940c7a2d04f236e8ef836&pageSize=${this.props.pageSize}&page=${this.state.pageNo}`;
